...
import { useFindNearestTodayParcelQuery } from '@/libs/features/services/parcel/parcelApi';
...
const NearestTodayParcel: React.FC<BookedNearestParcelsProps> = ({
  id,
  setId,
}) => {
...
export default NearestTodayParcel;
