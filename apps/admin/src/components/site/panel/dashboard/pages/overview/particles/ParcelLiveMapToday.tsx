...
import { useFindMapMetricsTodayQuery } from '@/libs/features/services/analytics/parcelAnalyticsApi';
...
const ParcelLiveMapToday = () => {
  const { data, isLoading, isError } = useFindMapMetricsTodayQuery();
...
export default ParcelLiveMapToday;
